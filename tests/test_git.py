...
class GitTest(PatchewTestCase):
    ...
    def test_result_data_automatic_url(self):
        ...
        resp = self.api_client.put(self.PROJECT_BASE + 'series/20160628014747.20971-1-famz@redhat.com/results/git/', {
                'status': 'success',
                'data': {
                    'repo': self.repo,
        ...
        resp = self.api_client.get(self.PROJECT_BASE + 'series/20160628014747.20971-1-famz@redhat.com/results/git/')
